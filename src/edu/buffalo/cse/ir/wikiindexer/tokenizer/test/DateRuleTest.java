...
public class DateRuleTest extends TokenizerRuleTest {
	...
	public void testRule() {
		if (rule == null) {
			...
			try {
				assertArrayEquals(
						new Object[] { "Vidya", "Balan", "born", "19780101",
				...
				assertArrayEquals(
						...
						runtest("President", "Franklin", "D.", "Roosevelt",
								"to", "proclaim", "December", "7,", "1941,",
								"'a", "date", "which", "will", "live", "in",
								"infamy'"));
				assertArrayEquals(
						new Object[] { "The", "Academy", "operated", "until",
								"it", "was", "destroyed", "by", "Lucius",
								"Cornelius", "Sulla", "in", "-00840101" },
						runtest("The", "Academy", "operated", "until", "it",
								"was", "destroyed", "by", "Lucius",
								"Cornelius", "Sulla", "in", "84", "BC"));
				assertArrayEquals(
						new Object[] { "For", "instance,", "the", "19480101",
								"ABL", "finalist", "Baltimore", "Bullets",
								"moved", "to", "the", "BAA", "and", "won",
								"that", "league's", "19480101", "title." },
						runtest("For", "instance,", "the", "1948", "ABL",
								"finalist", "Baltimore", "Bullets", "moved",
				...
				assertArrayEquals(
						new Object[] { "Pune", "is", "known", "to", "have",
								...
								"08470101." },
						runtest("Pune", "is", "known", "to", "have", "existed",
								"as", "a", "town", "since", "847", "AD."));
				assertArrayEquals(
						new Object[] { "The", "20040101", "Indian", "Ocean",
								"earthquake", "was", "an", "undersea",
								"megathrust", "earthquake", "that", "occurred",
								"at", "20041226 00:58:53" },
						runtest("The", "2004", "Indian", "Ocean", "earthquake",
								"was", "an", "undersea", "megathrust",
								"earthquake", "that", "occurred", "at",
								"00:58:53", "UTC", "on", "Sunday,", "26",
								"December", "2004"));
				assertArrayEquals(
						new Object[] { "19000411", "is", "the", "101st", "day",
